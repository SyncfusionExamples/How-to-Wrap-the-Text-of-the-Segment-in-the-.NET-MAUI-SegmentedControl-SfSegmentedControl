# How to Wrap the Text of the Segment in the .NET MAUI SegmentedControl (SfSegmentedControl)

This repository contains the sample code to wrap the text of the segment in the [SfSegmentedControl](https://help.syncfusion.com/maui/segmented-control/getting-started).
